...
$routes[] = new MvcContext('/rest/storage', 'GET', "Apps\\Cores\\Controllers\\Rest\\StorageCtrl", 'get');
$routes[] = new MvcContext('/rest/storage', 'PUT', "Apps\\Cores\\Controllers\\Rest\\StorageCtrl", 'update');
$routes[] = new MvcContext('/rest/storage', 'DELETE', "Apps\\Cores\\Controllers\\Rest\\StorageCtrl", 'delete');
